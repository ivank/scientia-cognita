defmodule ScientiaCognitaWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: ScientiaCognitaWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ScientiaCognitaWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ScientiaCognitaWeb.Gettext, "errors", msg, opts)
    end
  end
