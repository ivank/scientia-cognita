...
config :scientia_cognita, ScientiaCognita.Repo,
  database: Path.expand("../scientia_cognita_dev.db", __DIR__),
  pool_size: 5,
  stacktrace: true,
...
config :scientia_cognita, ScientiaCognitaWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "5rwMy+wwp6/6daPZ5LmuL39MyBtYa/xP/mHJafgnPYDS6OPbhsqtcax6K7hKwUTZ",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:scientia_cognita, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:scientia_cognita, ~w(--watch)]}
  ]
...
config :scientia_cognita, dev_routes: true
